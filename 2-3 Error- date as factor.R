{
  ...
  # This time we did not use stringAsFactor = FALSE
  # So, the date will be treated as a factor
  ...
  for(i in 1:14)
  {
    ...
    if(weatherData[i,"precipitation"] > 1) 
    {
      ...
      # BUT, since date is a factor, the factor number (1-14) will be 
      # output to the console instead of the date (Mar27-Apr9)
